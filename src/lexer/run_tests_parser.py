...
Exemplos (rodando da raiz do repositório):
    python run_tests_parser.py src/lexer/python/parser.py src/testes-parser-50/casos
    python run_tests_parser.py src/lexer/c/parser.exe src/testes-parser-50/casos --exe
"""
